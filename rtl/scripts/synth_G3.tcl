# ============================================================================
# synth_G3.tcl — Synthesis + Implementation for G=3 (TeLLMe baseline)
#
# Usage: Open Vivado TCL console, then:
#   cd C:/path/to/bitnet2lut/rtl
#   source scripts/synth_G3.tcl
#
# Or from command line:
#   vivado -mode batch -source scripts/synth_G3.tcl
#
# Output reports saved to: results/reports_G3/
#
# Author: Rajat Gupta
# ============================================================================
