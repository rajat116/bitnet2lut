# ============================================================================
# synth_INT8_baseline.tcl
# Synthesis of INT8 uniform baseline (current standard)
# ============================================================================
...
set rpt_dir "${OUT_DIR}/reports_INT8_baseline"

file mkdir $OUT_DIR
file mkdir $rpt_dir

puts "============================================================"
puts "SYNTHESIS: INT8 baseline (ACT_WIDTH=8, VALUE_WIDTH=16)"
puts "Target: ${PART}"
puts "============================================================"

set proj_name "tlmm_INT8_baseline"
...
puts $fp "Config: INT8_baseline"
puts $fp "ACT_WIDTH: 8"
puts $fp "VALUE_WIDTH: 16"
puts $fp "WNS: ${wns}"
puts $fp "Fmax: ${fmax}"
close $fp
